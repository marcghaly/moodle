...
$string['err_invalidelement'] = 'Element name : {$a} is not valid';
...
$string['fieldreview'] = 'Please review the following fields before submission :';
...
$string['newvalue'] = 'New value : <strong>{$a}</strong>';
