...
$string['regradeanyway'] = 'Do you want to save anyway?';
$string['regradewarning'] = 'This question is used in at least one quiz opened by one or more students. Changes will apply as soon as you click on the "Save changes" button. If you want these changes to be applied to past attempts, you may have to regrade all attempts in quizzes containing this question.';
